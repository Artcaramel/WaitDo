	...
	<div class="productMargin" id="box" style="background-color: white;">
		<article class="product__main">
			...
			<!--		<div class="product-base-img-text">
				...
				<div class="product-main-view">
					<div class="product-main-container">
						<c:forEach items="${listKindProduct}" var="productkind" begin="10" end="10">
							<div class="product-main-container-sub">
								<div class="product-main-view-main">
								<a href="/waitdo/product/detail?pseq=${productkind.pseq}">
									<img class="product-main-view-main-img"
										src="/waitdo/WDImage/${productkind.image}">
									<!--     <img class="product-main-view-main-img"
                           src="/waitdo/WDImage/product-sub-1-1.jpg">-->
									<p class="left">${productkind.name}</p></a>
									<p class="right">
										<fmt:formatNumber value="${productkind.price2}"
											pattern="###,###,###" />
										원
									</p>
								</div>
					...
					<div class="product-main-container">
						<c:forEach items="${listKindProduct}" var="productkind" begin="1"
							end="2">
							<div class="product-main-container-sub">
								<div class="product-main-view-main">
								<a href="/waitdo/product/detail?pseq=${productkind.pseq}">
					...
					<div class="product-main-container">
						<c:forEach items="${listKindProduct}" var="productkind" begin="6"
							end="7">
							<div class="product-main-container-sub">
								<div class="product-main-view-main">
								<a href="/waitdo/product/detail?pseq=${productkind.pseq}">
			...
			<!--  <div class="product-base-img-div">
				...
				<div class="product-main-container-view">
					<div class="swiper-container">
						<div class="swiper-wrapper">
							<c:forEach items="${listKindProduct}" var="productkind" begin="4"
								end="14">
				...
				<div class="product-main-view">
					<div class="product-main-container">
						<c:forEach items="${listKindProduct}" var="productkind" begin="15"
							end="16">
							<div class="product-main-container-sub">
								<div class="product-main-view-main">
                            <a href="/waitdo/product/detail?pseq=${productkind.pseq}">
									<img class="product-main-view-main-img"
										src="/waitdo/WDImage/${productkind.image}"></a>
									<p class="left">${productkind.name}</p>
									<p class="right">
										<fmt:formatNumber value="${productkind.price2}"
											pattern="###,###,###" />
										원
					...
					<div class="product-main-container">
						<c:forEach items="${listKindProduct}" var="productkind" begin="17"
							end="18">
							<div class="product-main-container-sub">
								<div class="product-main-view-main">
								<a href="/waitdo/product/detail?pseq=${productkind.pseq}">
